...
Hint - Can we put a for loop inside another for loop? YES WE CAN! Use another name (usually j) for the nested loop.
*/
...
console.log(isPresent2d(myArr2d2, 9)) // --> false
console.log(isPresent2d(myArr2d2, 6)) // --> true
...
var lastElement = anotherArr.pop()
console.log(`anotherArr: ${anotherArr}, lastElement: ${lastElement}`)
